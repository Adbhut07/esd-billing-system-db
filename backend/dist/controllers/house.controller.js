...
const createHouseSchema = zod_1.z.object({
    mohallaId: zod_1.z.number().int().positive(),
    houseNumber: zod_1.z.string().min(1),
    consumerCode: zod_1.z.string().min(1),
    department: zod_1.z.string().optional(),
    licenseeName: zod_1.z.string().min(1),
    electricityMeterNumber: zod_1.z.string().optional(),
    waterMeterNumber: zod_1.z.string().optional(),
    mobileNumber: zod_1.z.string().optional(),
    email: zod_1.z.string().email().optional().or(zod_1.z.literal('')),
    licenseFee: zod_1.z.number().min(0).optional(),
    residenceFee: zod_1.z.number().min(0).optional(),
});
const updateHouseSchema = zod_1.z.object({
    mohallaId: zod_1.z.number().int().positive().optional(),
    houseNumber: zod_1.z.string().min(1).optional(),
    consumerCode: zod_1.z.string().min(1).optional(),
    department: zod_1.z.string().optional(),
    licenseeName: zod_1.z.string().min(1).optional(),
    electricityMeterNumber: zod_1.z.string().optional(),
    waterMeterNumber: zod_1.z.string().optional(),
    mobileNumber: zod_1.z.string().optional(),
    email: zod_1.z.string().email().optional().or(zod_1.z.literal('')),
...
const updateLicenseFeeSchema = zod_1.z.object({
    mohallaNumber: zod_1.z.string().min(1),
    houseNumber: zod_1.z.string().min(1),
    licenseFee: zod_1.z.number().min(0),
});
const updateResidenceFeeSchema = zod_1.z.object({
    mohallaNumber: zod_1.z.string().min(1),
    houseNumber: zod_1.z.string().min(1),
    residenceFee: zod_1.z.number().min(0),
});
const getHousesQuerySchema = zod_1.z.object({
    mohallaId: zod_1.z.string().optional(),
    mohallaNumber: zod_1.z.string().optional(),
    houseNumber: zod_1.z.string().optional(),
    consumerCode: zod_1.z.string().optional(),
...
const houseIdentifierSchema = zod_1.z.object({
...
class HouseController {
    ...
    static async getAllHouses(req, res) {
        try {
            ...
            const { mohallaId, mohallaNumber, houseNumber, consumerCode, isActive, page, limit, } = validationResult.data;
            const where = {};
            if (mohallaId) {
    ...
    static async getHouseByMohallaAndHouseNumber(req, res) {
        try {
            // Validate query parameters
    ...
    static async updateLicenseFee(req, res) {
        try {
            // Validate request body
    ...
    static async updateResidenceFee(req, res) {
        try {
            // Validate request body
    ...
    static async permanentlyDeleteHouse(req, res) {
        try {
            // Validate params
            const validationResult = idParamSchema.safeParse(req.params);
            if (!validationResult.success) {
    ...
    static async restoreHouse(req, res) {
        try {
            // Validate params
            const validationResult = idParamSchema.safeParse(req.params);
            if (!validationResult.success) {
